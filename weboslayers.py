...
# Supported MACHINE-s
Machines = ['raspberrypi3','qemux86','dragonboard-410c']
...
('meta-ros2',                 38, 'git://github.com/lgsvl/meta-ros2.git',                   'branch=ros2pr,commit=fac79da',''),
('meta-webos',                40, 'git://github.com/webosose/meta-webosose.git',            'branch=master,commit=8699f9b', ''),
...
('meta-qcom',                 52, 'git://git.yoctoproject.org/meta-qcom',                   'branch=morty',''),

('meta-webos-ros2',           54, 'git://github.com/webosose/meta-webosose.git',            '', ''),
]
